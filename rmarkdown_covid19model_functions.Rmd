...
?It's an S(?E)IR model but with ?Not really sure how they link tbh? approximations for the derivatives. Note that there's no spatial element. No underlying clustering model based on geographical location. Seems like there should be?!?!
