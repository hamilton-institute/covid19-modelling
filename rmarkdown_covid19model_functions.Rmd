---
title: "Imperial Covid19 Code - base.stan functions used in base.r"
...
This is our attempt to annotate and understand the Covid-19 modelling functions in "base.stan"code made public at <https://github.com/ImperialCollegeLondon/covid19model>. 
...
"The renewal model is related to the Susceptible-Infected-Recovered model, except the renewal is not expressed in differential form" What does related to mean!!
So its linked to an SIR model - not sEir. Approximations for the derivatives. Note that there's no spatial element. No underlying clustering model based on geographical location. Seems like there should be?!?!
